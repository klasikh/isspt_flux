...
const Motif = ({ motif }: InferGetServerSidePropsType<typeof getServerSideProps>) => {
  ...
  return (
    <div>
      <Head>
        <title>Informations d'un motif</title>
      ...
      <div className="container mx-auto max-w-lg">
        ...
        <h1 className="text-2xl font-bold mb-3 uppercase text-center">Informations du motif</h1>
        <div className="w-full bg-white rounded overflow-hidden shadow-lg">
          <div className="px-6 py-4">
            <div className="font-bold text-xl mb-4 block bg-gray-600 p-1 text-white">Nom: {motif.name}</div>
