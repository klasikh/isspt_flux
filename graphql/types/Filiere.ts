    ...
    fields: (t) => ({
        createFiliere: t.prismaField({
            ...
            resolve: async (query, _parent, args, ctx) => {
              ...
              const theFiliere = await prisma.filiere.create({
                ...query,
                data: {
                  name,
                  description,
              ...
              return {
                name: theFiliere.name,
                description: theFiliere.description
              }
            }
        }),

        updateFiliere: t.prismaField({
            type: "Filiere",
            args: {
              id: t.arg.id({ required: true }),
              name: t.arg.string(),
